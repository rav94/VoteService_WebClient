...
<head>
    ...
    <?php echo HTML::style('css/login-page.css'); ?>
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar navbar-inverse">
            ...
            <a class="navbar-brand" href="/"><span><i class="fa "></i></span>&nbsp;Bus API</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php /*<a href="user/logout" class="btn btn-danger" role="button">LogOut</a>*/ ?>
    ...
    <div class="row">
        ...
        <?php if($error!=null): ?>
            <div class="col-md-6 col-md-offset-3">
                <div class="<?php echo e($alert); ?>" style="text-align: center">
...
<?php echo HTML::script('js/vendor/jquery.min.js'); ?>
